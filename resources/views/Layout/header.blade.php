...
<head>
    ...
    <!-- plugins:css -->
    <link rel="stylesheet" href="{{url('')}}/assets/assets/vendors/feather/feather.css">
    <link rel="stylesheet" href="{{url('')}}/assets/assets/vendors/mdi/css/materialdesignicons.min.css">
    <link rel="stylesheet" href="{{url('')}}/assets/assets/vendors/ti-icons/css/themify-icons.css">
    <link rel="stylesheet" href="{{url('')}}/assets/assets/vendors/font-awesome/css/font-awesome.min.css">
    <link rel="stylesheet" href="{{url('')}}/assets/assets/vendors/typicons/typicons.css">
    <link rel="stylesheet" href="{{url('')}}/assets/assets/vendors/simple-line-icons/css/simple-line-icons.css">
    <link rel="stylesheet" href="{{url('')}}/assets/assets/vendors/css/vendor.bundle.base.css">
    <link rel="stylesheet" href="{{url('')}}/assets/assets/vendors/bootstrap-datepicker/bootstrap-datepicker.min.css">
    <!-- endinject -->
    <!-- Plugin css for this page -->
    <link rel="stylesheet" href="{{url('')}}/assets/assets/vendors/datatables.net-bs4/dataTables.bootstrap4.css">
    <link rel="stylesheet" type="text/css" href="{{url('')}}/assets/assets/js/select.dataTables.min.css">
...
<body class="with-welcome-text">
                                                                    ...
                                                                    <table class="table select-table">
                                                                        ...
                                                                        <tbody>
                                                                            <tr>
                                                                                ...
                                                                                <td>
                                                                                    <div class="d-flex ">
                                                                                        <img src="{{url('')}}/assets/assets/images/faces/face1.jpg"
                                                                                            alt="">
                                                                                        <div>
                                                                            ...
                                                                            <tr>
                                                                                ...
                                                                                <td>
                                                                                    <div class="d-flex">
                                                                                        <img src="{{url('')}}/assets/assets/images/faces/face2.jpg"
                                                                                            alt="">
                                                                                        <div>
                                                                                            <h6>Laura Brooks</h6>
                                                                                            <p>Head admin</p>
                                                                            ...
                                                                            <tr>
                                                                                ...
                                                                                <td>
                                                                                    <div class="d-flex">
                                                                                        <img src="{{url('')}}/assets/assets/images/faces/face3.jpg"
                                                                                            alt="">
                                                                                        <div>
                                                                                            <h6>Wayne Murphy</h6>
                                                                                            <p>Head admin</p>
                                                                            ...
                                                                            <tr>
                                                                                ...
                                                                                <td>
                                                                                    <div class="d-flex">
                                                                                        <img src="{{url('')}}/assets/assets/images/faces/face4.jpg"
                                                                                            alt="">
                                                                                        <div>
                                                                            ...
                                                                            <tr>
                                                                                ...
                                                                                <td>
                                                                                    <div class="d-flex">
                                                                                        <img src="{{url('')}}/assets/assets/images/faces/face5.jpg"
                                                                                            alt="">
                                                                                        <div>
                                                                    ...
                                                                    <div class="col-lg-12">
                                                                        ...
                                                                        <div class="mt-3">
                                                                            <div
                                                                                ...
                                                                                <div class="d-flex">
                                                                                    <img class="img-sm rounded-10"
                                                                                        src="{{url('')}}/assets/assets/images/faces/face1.jpg"
                                                                                        alt="profile">
                                                                            ...
                                                                            <div
                                                                                ...
                                                                                <div class="d-flex">
                                                                                    <img class="img-sm rounded-10"
                                                                                        src="{{url('')}}/assets/assets/images/faces/face2.jpg"
                                                                                        alt="profile">
                                                                                    <div class="wrapper ms-3">
                                                                                        <p class="ms-1 mb-1 fw-bold">
                                                                                            Wayne Murphy</p>
                                                                            ...
                                                                            <div
                                                                                ...
                                                                                <div class="d-flex">
                                                                                    <img class="img-sm rounded-10"
                                                                                        src="{{url('')}}/assets/assets/images/faces/face3.jpg"
                                                                                        alt="profile">
                                                                                    <div class="wrapper ms-3">
                                                                                        <p class="ms-1 mb-1 fw-bold">
                                                                                            Katherine Butler</p>
                                                                            ...
                                                                            <div
                                                                                ...
                                                                                <div class="d-flex">
                                                                                    <img class="img-sm rounded-10"
                                                                                        src="{{url('')}}/assets/assets/images/faces/face4.jpg"
                                                                                        alt="profile">
                                                                                    <div class="wrapper ms-3">
                                                                                        <p class="ms-1 mb-1 fw-bold">
                                                                                            Matthew Bailey</p>
                                                                            ...
                                                                            <div
                                                                                ...
                                                                                <div class="d-flex">
                                                                                    <img class="img-sm rounded-10"
                                                                                        src="{{url('')}}/assets/assets/images/faces/face5.jpg"
                                                                                        alt="profile">
                                                                                    <div class="wrapper ms-3">
                                                                                        <p class="ms-1 mb-1 fw-bold">
                                                                                            Rafell John</p>
    ...
    <script src="{{url('')}}/assets/assets/vendors/bootstrap-datepicker/bootstrap-datepicker.min.js"></script>
    <!-- endinject -->
    <!-- Plugin js for this page -->
    <script src="{{url('')}}/assets/assets/vendors/chart.js/chart.umd.js"></script>
    ...
    <script src="{{url('')}}/assets/assets/js/jquery.cookie.js" type="text/javascript"></script>
